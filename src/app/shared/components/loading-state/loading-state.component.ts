    ...
    <div class="flex items-center justify-center py-8" [ngClass]="containerClass">
      ...
      @if (type === 'pulse') {
        <div class="flex flex-col items-center space-y-4">
          <div class="animate-pulse bg-amber-100 rounded-lg" [ngClass]="getPulseSizeClass()"></div>
          <div class="animate-pulse bg-amber-100 rounded-lg" [ngClass]="getPulseSizeClass()"
